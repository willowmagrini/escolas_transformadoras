	...
	<main id="content" class="<?php echo odin_classes_page_full(); ?>" tabindex="-1" role="main">
			...
			<div class="row papel sem-margem"><!-- row papel -->
				<div class="col-md-6 pull-right ">
					...
					<p>O papel da escola tem sido tradicionalmente o de transmitir conteúdos e reproduzir os modelos sociais vigentes por meio de métodos de repetição. Mais do que nunca, é preciso repensar o papel da escola. <a href="/saiba-como" >SAIBA COMO!</a></p>
				</div>
